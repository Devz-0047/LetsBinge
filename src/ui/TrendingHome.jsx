...
function TrendingHome() {
  ...
  return (
    <div className="x max-w-[280px] rounded-r-md bg-slate-950">
      <p className="bg-slate-950 pl-3 text-center text-[22px] font-semibold text-orange-600">
        Trending
      </p>
      ...
      {trendingMovie && (
        <ul className="bg-slate-950">
          {trendingMovie.map((movie) => (
            <li
              className="bg-slate-950 pl-1 font-semibold text-orange-400"
              key={movie.id}
            >
              <div className="flex items-center justify-center gap-2 bg-slate-950">
                <div>
                  <img
                ...
                <div className="bg-slate-950">
                  ...
                  <p className="bg-slate-950 text-[14px] text-orange-400">
                    Ratting: {movie.vote_average.toFixed(1)}/10
                  </p>
                  <p className="bg-slate-950 text-[14px] text-orange-400">
